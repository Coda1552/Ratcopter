...
public class RatcopterModel<T extends Entity> extends EntityModel<T> {
    ...
    public RatcopterModel() {
        this.texWidth = 512;
        this.texHeight = 128;
        this.tailProp3 = new ModelRenderer(this, 64, 0);
        this.tailProp3.setPos(0.0F, 0.0F, 0.0F);
        this.tailProp3.texOffs(66, 0).addBox(0.0F, -1.0F, -5.0F, 26.0F, 1.0F, 10.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(tailProp3, 0.0F, -2.0943951023931953F, 0.0F);
        this.noseProp1 = new ModelRenderer(this, 64, 0);
        this.noseProp1.setPos(0.0F, -0.5F, -5.0F);
        this.noseProp1.texOffs(170, 0).addBox(-3.0F, -10.0F, -1.0F, 6.0F, 10.0F, 1.0F, 0.0F, 0.0F, 0.0F);
        this.tailProp1 = new ModelRenderer(this, 64, 0);
        this.tailProp1.setPos(0.0F, 0.0F, 0.0F);
        this.tailProp1.texOffs(66, 0).addBox(0.0F, -1.0F, -5.0F, 26.0F, 1.0F, 10.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.armRightProp1 = new ModelRenderer(this, 0, 32);
        this.armRightProp1.setPos(0.0F, 0.0F, 0.0F);
        this.armRightProp1.texOffs(0, 56).addBox(0.0F, -1.0F, -5.0F, 30.0F, 1.0F, 10.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(armRightProp1, 0.0F, 2.0943951023931953F, 0.0F);
        this.armRight2 = new ModelRenderer(this, 64, 11);
        this.armRight2.setPos(-36.0F, -4.0F, 0.0F);
        this.armRight2.texOffs(372, 0).addBox(-4.0F, -20.0F, -4.0F, 8.0F, 20.0F, 8.0F, 0.0F, 0.0F, 0.0F);
        this.armLeft1 = new ModelRenderer(this, 64, 32);
        this.armLeft1.mirror = true;
        this.armLeft1.setPos(16.0F, -7.0F, -20.0F);
        this.armLeft1.texOffs(284, 53).addBox(0.0F, -4.0F, -4.0F, 40.0F, 8.0F, 8.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.armRightProp2 = new ModelRenderer(this, 64, 32);
        this.armRightProp2.setPos(0.0F, 0.0F, 0.0F);
        this.armRightProp2.texOffs(0, 56).addBox(0.0F, -1.0F, -5.0F, 30.0F, 1.0F, 10.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.armLeft2 = new ModelRenderer(this, 64, 11);
        this.armLeft2.setPos(36.0F, -4.0F, 0.0F);
        this.armLeft2.texOffs(372, 0).addBox(-4.0F, -20.0F, -4.0F, 8.0F, 20.0F, 8.0F, 0.0F, 0.0F, 0.0F);
        this.headlamp = new ModelRenderer(this, 64, 11);
        this.headlamp.setPos(0.0F, -4.5F, -9.0F);
        this.headlamp.texOffs(66, 0).addBox(-3.5F, -3.5F, -2.0F, 7.0F, 7.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.armRightProp3 = new ModelRenderer(this, 64, 32);
        this.armRightProp3.setPos(0.0F, 0.0F, 0.0F);
        this.armRightProp3.texOffs(0, 56).addBox(0.0F, -1.0F, -5.0F, 30.0F, 1.0F, 10.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.hatLeft = new ModelRenderer(this, 64, 11);
        this.hatLeft.setPos(10.0F, 1.0F, 0.5F);
        this.hatLeft.texOffs(337, 0).addBox(-2.0F, 0.0F, -4.5F, 2.0F, 13.0F, 9.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.propellerNose = new ModelRenderer(this, 64, 0);
        this.propellerNose.setPos(0.0F, -4.5F, -5.0F);
        this.propellerNose.texOffs(305, 0).addBox(-2.5F, -3.0F, -5.0F, 5.0F, 5.0F, 5.0F, 0.0F, 0.0F, 0.0F);
        this.armLeftProp2 = new ModelRenderer(this, 64, 32);
        this.armLeftProp2.setPos(0.0F, 0.0F, 0.0F);
        this.armLeftProp2.texOffs(0, 56).addBox(0.0F, -1.0F, -5.0F, 30.0F, 1.0F, 10.0F, 0.0F, 0.0F, 0.0F);
        this.armRight1 = new ModelRenderer(this, 64, 32);
        this.armRight1.setPos(-16.0F, -7.0F, -20.0F);
        this.armRight1.texOffs(284, 53).addBox(-40.0F, -4.0F, -4.0F, 40.0F, 8.0F, 8.0F, 0.0F, 0.0F, 0.0F);
        this.tail1 = new ModelRenderer(this, 82, 18);
        this.tail1.setPos(0.0F, -7.5F, 33.0F);
        this.tail1.texOffs(298, 0).addBox(-3.0F, -3.5F, 0.0F, 6.0F, 7.0F, 44.0F, 0.0F, 0.0F, 0.0F);
        this.tailProp2 = new ModelRenderer(this, 64, 0);
        this.tailProp2.setPos(0.0F, 0.0F, 0.0F);
        this.tailProp2.texOffs(66, 0).addBox(0.0F, -1.0F, -5.0F, 26.0F, 1.0F, 10.0F, 0.0F, 0.0F, 0.0F);
        this.basket = new ModelRenderer(this, 64, 0);
        this.basket.setPos(0.0F, 11.0F, 0.0F);
        this.basket.texOffs(132, 0).addBox(-14.0F, 0.0F, -27.5F, 28.0F, 22.0F, 55.0F, 0.0F, 0.0F, 0.0F);
        this.armLeftProp3 = new ModelRenderer(this, 64, 32);
        this.armLeftProp3.setPos(0.0F, 0.0F, 0.0F);
        this.armLeftProp3.texOffs(0, 56).addBox(0.0F, -1.0F, -5.0F, 30.0F, 1.0F, 10.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(armLeftProp3, 0.0F, -2.0943951023931953F, 0.0F);
        this.hat = new ModelRenderer(this, 64, 11);
        this.hat.setPos(0.0F, -2.0F, 13.0F);
        this.hat.texOffs(243, 0).addBox(-9.0F, -12.0F, -9.0F, 18.0F, 12.0F, 18.0F, 0.0F, 0.0F, 0.0F);
        this.hatRight = new ModelRenderer(this, 64, 11);
        this.hatRight.setPos(-10.0F, 1.0F, 0.5F);
        this.hatRight.texOffs(337, 0).addBox(0.0F, 0.0F, -4.5F, 2.0F, 13.0F, 9.0F, 0.0F, 0.0F, 0.0F);
        this.head = new ModelRenderer(this, 64, 0);
        this.head.setPos(0.0F, -3.5F, -33.0F);
        this.head.texOffs(122, 0).addBox(-8.0F, -7.5F, -16.0F, 16.0F, 15.0F, 16.0F, 0.0F, 0.0F, 0.0F);
        this.armLeftProp1 = new ModelRenderer(this, 64, 32);
        this.armLeftProp1.setPos(0.0F, 0.0F, 0.0F);
        this.armLeftProp1.texOffs(0, 56).addBox(0.0F, -1.0F, -5.0F, 30.0F, 1.0F, 10.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(armLeftProp1, 0.0F, 2.0943951023931953F, 0.0F);
        this.noseProp3 = new ModelRenderer(this, 64, 0);
        this.noseProp3.setPos(0.0F, -0.5F, -5.0F);
        this.noseProp3.texOffs(170, 0).addBox(-3.0F, -10.0F, -1.0F, 6.0F, 10.0F, 1.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(noseProp3, 0.0F, 0.0F, -2.0943951023931953F);
        this.hatBrim = new ModelRenderer(this, 64, 31);
        this.hatBrim.setPos(0.0F, 0.0F, 0.0F);
        this.hatBrim.texOffs(66, 0).addBox(-10.0F, -1.0F, -10.0F, 20.0F, 2.0F, 20.0F, 0.0F, 0.0F, 0.0F);
        this.noseProp2 = new ModelRenderer(this, 64, 0);
        this.noseProp2.setPos(0.0F, -0.5F, -5.0F);
        this.noseProp2.texOffs(170, 0).addBox(-3.0F, -10.0F, -1.0F, 6.0F, 10.0F, 1.0F, 0.0F, 0.0F, 0.0F);
